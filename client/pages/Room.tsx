        ...
        onCustomMessageReceived: (data: any) => {
            if (data.type === "agent:status" && data.generationId) {
                ...
                if (!data.replayed) {
                    ...
                    if (data.videoUrl)
                        placeVideoOnCanvas(data.videoUrl, mediaPrompt);
            ...
            try {
                ...
                editor.run(() => {
                    for (const move of moves) {
                        ...
                        if (
                            shape.parentId &&
                            !String(shape.parentId).startsWith("page:")
                        ) {
                    ...
                    <div className="voice-participant-list">
                        ...
                        <div className="voice-participant">
                            ...
                            <span className="voice-participant-name">
                                {displayName}
                                <span className="voice-participant-you">
                                    {" "}
                                    (You)
                                </span>
                            </span>
                        ...
                        {Array.from(vs.peers.values()).map((peer: PeerInfo) => (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background: hashToColor(peer.sessionId),
                                    }}
                                >
                                ...
                                <span
                                    className={`voice-participant-mute ${peer.muted ? "voice-participant-mute--muted" : ""}`}
                                >
                                    {peer.muted ? (
                                        <SmallMicOffIcon />
                                    ) : (
